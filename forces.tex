...
The dust grains do not need to be collected intact for the~element composition analysis. A~time of flight ({ToF}) spectroscopy of dust was performed in the~vicinity of the~comet {Halley} several times \citep{jessberger1988aspects}, which besides hydrogen ({H}) and oxygen ({O}) revealed mostly carbon ({C}), {Si}, {Mg}, and {Fe}. 
...
An~object orbits the~Sun on a circular orbit if the~magnitude of centrifugal force $F_c$ is equal to the~magnitude of gravity $F_g$. This condition gives the~\textit{circular speed} $v_c$ needed for the~equality: 
\begin{equation}
...
The power density of solar radiation at $1 \si{AU}$ is \citep{kopp2011new}
\begin{equation}
...
%Motion of charged grains immersed in the~solar system plasma is a~broad topic, and a~lot of literature is available on the~matter \citep{rusk1988effect,horanyi1996charged,mann2007nanoparticles,juhasz2013dynamics,stamm2019dust,czechowski2021dynamics,poppe2022effects}.
...
The \textit{rate of sublimation} of droplets is described by Langmuir's evaporation equation \citep{langmuir1918evaporation}:
\begin{equation}
